...
## v4.9.0
This release is primarily a dependency bump to catch up with 3 months worth of updates during my short hiatus from this project.

**Dependency Updates**
- Bump Alpine to 3.15
- Bump NodeJS to v16
- Bump RTSP Simple Server to v0.17.13
